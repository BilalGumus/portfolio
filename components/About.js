  ...
  return (
    <div className="flex h-full relative pb-[36px]">
      <div className="flex flex-col justify-end h-full p-[32px] md:p-[48px] lg:p-[64px]">
        <h2 className="text-white font-inter text-[36px] xs:text-[48px] md:text-[64px] font-bold mb-4">
          About me
        </h2>
        <h3 className="font-ptSerif text-[18px] xs:text-[24px] font-normal mb-4">
        ...
        <h3 className="font-ptSerif text-[18px] xs:text-[24px] font-normal">
